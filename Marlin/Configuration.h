...
#define STRING_CONFIG_H_AUTHOR "(Knute B., HICTOP 3DP-11)" // CL: updated info. Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Make it Grant" // CL: put version number on LCD menu
...
#define INVERT_E0_DIR true  // KB: extruder was rotating in wrong direction when false
...
#define DEFAULT_ACCELERATION          3000 // (mm/sec^2) CL: default for HIC i3 - X, Y, Z and E max acceleration for printing moves
